...
[![GoDoc](https://godoc.org/github.com/tidwall/btree?status.svg)](https://godoc.org/github.com/tidwall/qcgo)
...
Because regular cgo is too slow for my [TG](https://github.com/tidwall/tg) C 
library, and I very much want to run TG in Go at its fullest potential.

## When to use

For C functions that are fast. Ideally ones that run in pure userspace.
...
| Uses the network                        | No                 |
| Runs a long time. 100+ nanoseconds      | No                 |
...
A wrapper function is needed as a simple trampoline for handling the 
